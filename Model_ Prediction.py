...
#### Basic EDA of Data
data=pd.read_excel(r"C:/Users/USER/Desktop/Project 71 Cost Prediction/Final Coding Deployment/pro_71.xlsx")
data.shape
data.columns
data.describe()
data.info()
...
df= df_new[['Maintenance_cost','Marketing_cost','Profit_Margin','Duration_of_coaching_in_Hours','Debentures','Mode_of_Class','Level_of_Course']]
y = df_new.iloc[:, -1]
...
print(model.predict([[20000, 20000, 20000,100,2000,1,2]]))
