...
df= df_new[['Maintenance_cost','Marketing_cost','Salary_of_the_trainer','Duration_of_coaching_in_Hours','Mode_of_Class','Level_of_Course','Location']]
y = df_new.iloc[:, -1]
...
print(model.predict([[5000, 6000, 10000,120,2,3,0]]))
