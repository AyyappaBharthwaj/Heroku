...
df= dataset[['Maintenance_cost','Marketing_cost','Profit_Margin','Duration_of_coaching_in_Hours','Level_of_Course']]
#X = dataset.iloc[:, 2:16]
'''
...
def convert_to_int(word):
    word_dict = {'Beginner':1, 'Intermediate':2, 'Higher':3, 'nan':0, 0: 0}
    return word_dict[word]
...
print(model.predict([[5500, 6000, 10000,150,2]]))
